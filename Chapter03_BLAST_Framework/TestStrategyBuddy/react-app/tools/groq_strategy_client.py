...
def _build_prompt(issue):
    ...
    return f"""You are an expert QA Test Strategy Lead. Derive a Test Strategy strictly from the JIRA issue and the reference document below. Do not invent scope items, focus areas, or risks not supported by these inputs.
