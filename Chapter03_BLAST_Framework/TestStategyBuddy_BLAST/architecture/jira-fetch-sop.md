...
## Goal
Given JIRA credentials (baseUrl, email, apiToken) and a user-entered issue key, return a normalized payload matching the "JIRA Fetch Output" schema in `gemini.md`.
...
- `issueKey`: any valid issue key, e.g. `SCRUM-5` or `SCRUM-6`
