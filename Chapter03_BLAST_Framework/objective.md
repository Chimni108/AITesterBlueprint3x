...
You will be able to create a test plan based on the by fetching the SCRUM-5 automatically. @chapter03BLAST_Framework/B.L.A.S.T.md  

GROQ - openai/gpt-oss-120b (FREE)
fETCH JIRA -> emAIL, token, JIRA - SCRUM-5 