...
# Windows consoles default to cp1252 and crash on the emoji and typographic
# characters CrewAI and the model emit. Force UTF-8 on the output streams.
...
# Guarded like 01, so importing this module (e.g. from pytest) defines the crew
# without firing a live Groq call. The test decides when to kick off.
